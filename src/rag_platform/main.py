...
loaded, logging configured, middleware registered (in the order that
matters — see the comment above `add_middleware` calls below), and routers
mounted. `main.py` itself contains no business logic and no route handlers.
...
from rag_platform.core.middleware.error_handling import ErrorHandlingMiddleware
